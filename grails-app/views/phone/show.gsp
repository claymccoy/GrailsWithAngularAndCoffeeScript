...
<html>
<head>
  <title>Google Phone Detail</title>
  <meta name="layout" content="main">
</head>
<body>

<img ng-src="${resource(dir: "images/phones/")}{{mainImageUrl}}" class="phone">
...
<ul class="phone-thumbs">
  <li ng-repeat="img in phone.images">
    <img ng-src="${resource(dir: "images/phones/")}{{img}}" ng-click="setMainImage(img)">
  </li>
</ul>
